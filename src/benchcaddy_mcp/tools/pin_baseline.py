...
from .._shared import _analysis_options, _invalid_run_id_response, _response, _run_id
...
def pin_baseline(
    ...
    try:
        ...
        return _invalid_run_id_response(tool_name="pin_baseline", run_id=run_id, suggested_action="Use a run ID like 3 or 3.2.")
